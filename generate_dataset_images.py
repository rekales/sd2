...
# DIY goddamn diffusion pipeline
...
for itergen in range(1000):

    sample = df.sample()
    print(int(sample.iloc[0]['SAMPLE_ID']))
    ...
    # Latents and initial random noise
